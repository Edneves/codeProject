...
-->
    ...
    <div id="content">
      ...
      <nav class="navbar secondary" id="navbar">
            ...
            <div class="promo">
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      <img class="card-img-top" src="../img/Bebidas/blacklabel.jpg" width="250" height="220" alt="Card image cap">
                      <h5 class="card-title">
                        <h3>R$ 112,90</h3>
                      </h5>
                ...
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <a href="#" class="btn btn btn-ligh ">Comprar</a>
                      <a href="#" class="btn btn btn-ligh" name="teste" >Carrinho</a>
                    </div>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      <img class="card-img-top" src="../img/Bebidas/oldpar.jpg" alt="Card image cap" width="1000" height="220">
                      <h5 class="card-title">
                        <h3>R$ 115,90</h3>
                      </h5>
