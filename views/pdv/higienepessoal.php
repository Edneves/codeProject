            ...
            <div class="promo">
              <div class="row">
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      <img class="card-img-top" src="../img/Higiene Pessoal/desodorante.jfif" alt="Card image cap">
                      <h5 class="card-title">
                        <h3>R$ 9,99</h3>
                      </h5>
                ...
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      <img class="card-img-top" src="../img/Higiene Pessoal/escova.png" alt="Card image cap">
                      <h5 class="card-title">
                        <h3>R$ 13,89 3un</h3>
                      </h5>
                ...
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      <img class="card-img-top" src="../img/Higiene Pessoal/filtro solar 30Fps.jpg" alt="Card image cap">
                      <h5 class="card-title">
                        <h3>R$ 49,89</h3>
                      </h5>
                ...
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      <img class="card-img-top" src="../img/Higiene Pessoal/fiodental.jfif" alt="Card image cap" width="1000" height="220">
                      <h5 class="card-title">
                        <h3>R$ 8,99</h3>
                      </h5>
            ...
            <div class="promo">
              <div class="row">
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      <img class="card-img-top" src="../img/Higiene Pessoal/pastadedente.jpg" alt="Card image cap">
                      <h5 class="card-title">
                        <h3>R$ 4,89</h3>
                      </h5>
                ...
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      <img class="card-img-top" src="../img/Higiene Pessoal/perfume tabu.jpg" alt="Card image cap">
                      <h5 class="card-title">
                        <h3>R$ 14,99</h3>
                      </h5>
                ...
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      <img class="card-img-top" src="../img/Higiene Pessoal/Shampoo Baboon.jpg" alt="Card image cap">
                      <h5 class="card-title">
                        <h3>R$ 12,59</h3>
                      </h5>
