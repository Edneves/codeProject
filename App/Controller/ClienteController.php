 ...
 */
    ...
    class ClienteController {
        ...
        public function cadastrarCliente($dados) {
            ...
            $stmt = $conexao->prepare('INSERT INTO cliente(cpf, nome, endereco, email, senha) VALUES(:eCpf, :eNome, :eEndereco, :eEmail, :eSenha);');
            $stmt->bindParam(':eCpf', $dados['cpf']);
            $stmt->bindParam(':eNome', $dados['nome']);
            $stmt->bindParam(':eEndereco', $dados['endereco']);
            $stmt->bindParam(':eEmail', $dados['email']);
            //$stmt->bindParam(':eNomeDeUsuario',$dados['nomeDeUsuario']);
